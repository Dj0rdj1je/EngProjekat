		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('30 May 2023','tpgb').' <span class="changelog-version">'.esc_html__('2.0.7','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Improved : Plus Paste : Live Copy to Paste Content Import Media Improvements','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : TP Button : Add Fancy Box Popup options.','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : TP Search Bar : Reusable Block layout for search result','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : TP Post Image : Background Compatible With TP Container.','tpgb').'</li>';
						echo '<li>'.esc_html__('Revamped : TP Heading Title : Made it jQuery Free and converted in Vanilla JS for Top notch performance.','tpgb').'</li>';
						echo '<li>'.esc_html__('Revamped : TP Progress Bar : Progress type Made it jQuery Free and converted in Vanilla JS for Top notch performance.','tpgb').'</li>';
						echo '<li>'.esc_html__('Revamped : TP Smooth Scroll : Made it jQuery Free and converted in Vanilla JS for Top notch performance.','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : TP Heading Title : Title Limit Bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : TP Social Icons : Tooltip JS Bug Fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';

				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('12 May 2023','tpgb').' <span class="changelog-version">'.esc_html__('2.0.6','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Update : TP Post Content : Bug fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Component : Repeater : Bug fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('11 May 2023','tpgb').' <span class="changelog-version">'.esc_html__('2.0.5','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Added : TP Info Box : Dynamic Heading Tag option for Title and Description Fields','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : TP Data Table : Responsive Column Width Option for Table Header','tpgb').'</li>';
						echo '<li>'.esc_html__('Added : TP Search Bar : Disable option for Input Search Field','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : Polylang plugin : Site Editor Templates','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : WP Rocket : Generate Cache Exclude Dynamic CSS','tpgb').'</li>';
						echo '<li>'.esc_html__('Revamped : TP External Form Styler : Made it jQuery Free and converted in Vanilla JS for Top notch performance.','tpgb').'</li>';
						echo '<li>'.esc_html__('Deprecated : TP External Form Styler : Caldera Form Style Options deprecated','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Caching : On Demand Assets Cache bug fix template load','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Caching : Smart Optimized bug Fix','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Responsive CSS Bug Fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
