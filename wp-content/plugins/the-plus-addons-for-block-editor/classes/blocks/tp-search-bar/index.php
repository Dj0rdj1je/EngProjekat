...
function tpgb_tp_search_bar_render_callback( $attr, $content) {
	...
	$dataattr['tempid'] = (!empty($attr['blockTemplate'])) ? $attr['blockTemplate'] : '';
...
function tpgb_search(){
	...
	$style = !empty($_POST['style']) ? $_POST['style'] : 'style-1';
	$tempId = !empty($_POST['tempId']) ? $_POST['tempId'] : '';
	$styleColumn = !empty($_POST['styleColumn']) ? $_POST['styleColumn'] : 'tpgb-col-12 tpgb-col-lg-12 tpgb-col-md-12 tpgb-col-sm-12 tpgb-col-12';
	...
	$resultSetting = !empty($_POST['resultSetting']) ? $_POST['resultSetting'] : [];
